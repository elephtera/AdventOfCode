namespace AdventOfCode2021.Assignments.Day3
{
    ...
    {
        private IList<string> GetInputData()
        {
            var input = InputHandler.GetInputAsList(InputDay3.Input);
            return input;
        }
        ...
        {
            int position = 0;
            IList<string> inputsOxygen = GetInputData();
            IList<string> inputsCO2 = GetInputData();
        ...
        private IList<string> FilterInputs(IList<string> inputs, char v, int position)
        {
