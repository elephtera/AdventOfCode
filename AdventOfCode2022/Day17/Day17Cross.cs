...
{
    public class Day17Cross : IDay17Shape
    {
        private int x = 2;
        private int y = 0;
        private List<bool[]> heights;

        public Day17Cross(List<bool[]> heights)
        {
        ...
        {
            if (y == 0 ||
                y < heights.Count && heights[y][x] ||
                y - 1 < heights.Count && heights[y - 1][x + 1] ||
                y < heights.Count && heights[y][x + 2])
            {
                return false;
            }
        ...
        {
            if (x == 0 ||
                y + 2 < heights.Count && heights[y + 2][x] ||
                y + 1 < heights.Count && heights[y + 1][x - 1] ||
                y + 0 < heights.Count && heights[y + 0][x])
            {
                return;
            }
        ...
        {
            if (x == 4 ||
                y + 2 < heights.Count && heights[y + 2][x + 2] ||
